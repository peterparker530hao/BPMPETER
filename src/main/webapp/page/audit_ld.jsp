...
<div id="p" class="easyui-panel" title="${sessionScope.currentMemberShip.group.name}审批"
...
<div style="padding-top: 5px">
    <table id="dg" title="批注列表" class="easyui-datagrid"
           fitColumns="true"
           url="${pageContext.request.contextPath}/task/listHistoryComment.do?taskId=${param.taskId}"

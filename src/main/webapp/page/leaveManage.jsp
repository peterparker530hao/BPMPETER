...
<div id="dlg" class="easyui-dialog" style="width: 620px;height: 280px;padding: 10px 20px" closed="true"
     buttons="#dlg-buttons">
        ...
        <table cellpadding="8px">
            ...
            <tr>
                ...
                <td>
                    ...
                    <textarea type="text" id="leaveReason" name="leaveReason" rows="5" cols="49"
